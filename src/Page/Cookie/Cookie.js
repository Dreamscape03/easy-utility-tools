  ...
  return (
    <div>
      ...
      <div style={{padding:"1rem 10rem"}}>
        <h1>Cookie Policy for Online Clipboard</h1>

        <p>
          This is the Cookie Policy for Online Clipboard, accessible from
          https://onlineclipboard.org
        </p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              these to work the following social media sites including; , will
        ...
        <ul>
          <li>Email: webmaster@onlineclipboard.org</li>
        </ul>
      </div>
      <Footer/>
    </div>
